  ...
  private val objectMapper: ObjectMapper,
    ...
    should("not skip creation if alias doesn't exists") {
      ...
      mockWebServer.dispatcher =
        createDispatcher(
          mapOf(
            "GET" to "/_alias/filtered_actions" to MockResponse().setResponseCode(404),
            "PUT" to "/_aliases/filtered_actions" to MockResponse().setResponseCode(201),
          ),
        )
      ...
      mockWebServer.takeRequest().apply {
        path shouldBe "/_aliases/filtered_actions"
        method shouldBe "PUT"
